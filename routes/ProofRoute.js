...
const { getFileList, uploadFile, createFolder, getFileFromFolder, postDeleteFile, getDataFromFile, getProofFolderById, updateFolder } = require("../controller/ProofController");
